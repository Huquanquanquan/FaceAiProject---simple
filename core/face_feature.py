...
from core.feature.demo import IR_18, IR_50
from core.feature.demo import MobileNetV2
from core.face_matcher import EmbeddingMatching
...
if __name__ == "__main__":
    ...
    fr = FaceFeature(model_file="", net_name="mobilenet_v2", input_size=(112, 112), embedding_size=512, device=torch.device('cpu'))
    input_shape = (1, 3, 112, 112)
    pytorch2onnx.convert2onnx(fr.model, input_shape, input_names=['input'], output_names=['output'], device=torch.device('cpu'))
